import { canManagePatientData, requirePatientScope, requireRole } from "@/lib/auth/dal";
import { listMedicationLogsForPatient, recordMedicationLog } from "@/lib/db/medic-data";
